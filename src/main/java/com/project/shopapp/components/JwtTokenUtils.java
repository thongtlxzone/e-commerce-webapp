...
public class JwtTokenUtils {
    @Value("${jwt.expiration}") // .bean not lombok
    ...
    public String generateToken(UserEntity user) throws InvalidParamExeption {
        ...
        try {
            ...
            throw new InvalidParamExeption("Cannot create JWT token, error: " + e.getMessage());
        }
    }
    private Key getSignInKey(){
        byte[] bytes = Decoders.BASE64.decode(secretKey);//Keys.hmacShaKeyFor(Decoders.BASE64.decode("T8fKkHKJ8An6bhxSxA9j8OtPktz7xl/ojSjLhcNYc9s="));
